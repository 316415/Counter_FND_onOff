...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { i_onOff  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
# set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_mode  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
...
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { i_mode }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
